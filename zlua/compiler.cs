...
namespace zlua
{
    ...
    class Compiler : ILuaListener
    {
        ...
        public void EnterFunc_def_stat([NotNull] LuaParser.Func_def_statContext context)
        {
            ...
            append_instr(new Lua.closure(curr_func.inner_funcs.Count()));
            append_instr(new Lua.mov(context.funcname().GetText()));
        ...
        {
            append_instr(new Lua.mov(context.var().GetText()));
        }
        ...
        {
            append_instr(new Lua.push(Lua.lua_TValue.bool_factory(false)));
        }
        ...
        {
            append_instr(new Lua.call(context.varOrExp().var().NAME().GetText()));
        }
        ...
        {
            append_instr(new Lua.push(Lua.lua_TValue.nil_factory()));
        }
        ...
        {
            var num = Lua.lua_TValue.n_factory(lua_Number.Parse(context.number().GetText()));
            append_instr(new Lua.push(num));
        }
        ...
        public void ExitOp_add_sub_exp([NotNull] LuaParser.Op_add_sub_expContext context)
        {
            ...
            if (punc == "+") append_instr(new Lua.add());
            //else if (punc == "-") append_instr(new Lua.sub());
        }
        ...
        public void ExitOp_mul_div_exp([NotNull] LuaParser.Op_mul_div_expContext context)
        {
            ...
            if (punc == "*") append_instr(new Lua.mul());
            //else if (punc == "/") append_instr(new Lua.div());
        }
        ...
        public void ExitPrefixexp([NotNull] LuaParser.PrefixexpContext context)
        {
            ...
            if (a.Length == 0) append_instr(new Lua.push_var(context.varOrExp().GetText()));
            else append_instr(new Lua.call( context.varOrExp().var().NAME().GetText()));
        }
        ...
        public void ExitString_exp([NotNull] LuaParser.String_expContext context)
        {
            ...
            append_instr(new Lua.push(Lua.lua_TValue.tstring_factory(s)));
        }
        ...
        {
            append_instr(new Lua.push(Lua.lua_TValue.bool_factory(true)));
        }
