...
public class stringtable
{
  ...
  public LUAI_UINT32 nuse = new LUAI_UINT32(); // number of elements
  public int size;
}
...
public class CallInfo
{
  ...
  public readonly LUAI_UINT32 savedpc;
...
//C++ TO C# CONVERTER TODO TASK: The following statement was not recognized, possibly due to an unrecognized macro:
  struct Table * mt[(DefineConstants.LUA_TTHREAD + 1)]; // metatables for basic types
  public TString[] tmname = Arrays.InitializeWithDefaultInstances<TString>((int)TMS.TM_N); // array with tag-method names
}
...
public class lua_State
{
  ...
  public readonly LUAI_UINT32 savedpc; // `savedpc' of current function
...
//C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
//ORIGINAL LINE: #define state_size(x) (sizeof(x) + LUAI_EXTRASPACE)
//C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
//ORIGINAL LINE: #define fromstate(l) (cast(lu_byte *, (l)) - LUAI_EXTRASPACE)
//C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
//ORIGINAL LINE: #define tostate(l) (cast(lua_State *, cast(lu_byte *, l) + LUAI_EXTRASPACE))
