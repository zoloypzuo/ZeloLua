...
public interface ILuaVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="LuaParser.tableOrFunc"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitTableOrFunc([NotNull] LuaParser.TableOrFuncContext context);

	/// <summary>
	/// Visit a parse tree produced by <see cref="LuaParser.methodname"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMethodname([NotNull] LuaParser.MethodnameContext context);
