...
public class Mbuffer
{
  ...
  public size_t n = new size_t();
  public size_t buffsize = new size_t();
}
...
public class Zio
{
  public size_t n = new size_t(); // bytes still unread
  public readonly string p; // current position in buffer
