...
------------------------------
failed to compile learn.lua:4: '=' expected near 'continue'
...
; (17)  for k, v in pairs(a) do print(v) end --> 2
...
; (22)  setmetatable(o, {__gc = function (o) print(o.x) end})
