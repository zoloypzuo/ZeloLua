...
.function  0 0 2 2
.const  "print"  ; 0
.const  "Hellow World!"  ; 1
[1] getglobal  0   0        ; R0 := print
[2] loadk      1   1        ; R1 := "Hellow World!"
[3] call       0   2   1    ;  := R0(R1)
[4] return     0   1        ; return 
; end of function 0
...
0033  41400000           [2] loadk      1   1        ; R1 := "Hellow World!"
...
0053  0E00000000000000   string size (14)
005B  48656C6C6F772057+  "Hellow W"
0063  6F726C642100       "orld!\0"
                         const [1]: "Hellow World!"
                         * functions:
