...
--[[-------------------------------------------------------------------
  ...
  ChunkSpy was inspired by Nick Trout's vmmerge5.file
...
--[[-------------------------------------------------------------------
-- Notes:
-- * See 5.0.2/ChunkSpy.file for script notes and outline
--]]-------------------------------------------------------------------
...
example:
  >luac myscript.file
  >%s luac.out myscript.file -o myscript.lst
...
-- * See 5.0.2/ChunkSpy.file for IEEE floating-point notes
--]]-------------------------------------------------------------------
...
function main()
  ---------------------------------------------------------------
  -- arg[0] is not set if ChunkSpy.file is embedded, for ChunkSpy.c
  ---------------------------------------------------------------
  local usage, exec
  if arg[0] then exec = "file ChunkSpy.file" else exec = "ChunkSpy" end
